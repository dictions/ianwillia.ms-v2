	...
	<section id="work" class="row">
		<div class="first-row">
			...
			<div class="showcase-row bottom">
				<a class="showcase-col flush-top" col="7" href="/work/greenhouse-go">
					<span annotation="right flush-top">01.</span>
					<figure aspect-ratio="4x3">
						<?php snippet('img', array('src' => '/assets/images/home/ghg.jpg')) ?>
					</figure>
				</a>
		...
		<div class="da-rest">
			<div class="showcase-row top">
				<a class="showcase-col" col="large-4" href="/work/formlets">
					<span annotation>02.</span>
					<figure aspect-ratio="1x2">
						<?php snippet('img', array('src' => '/assets/images/home/formlets.jpg')) ?>
					</figure>
				</a>
				<a class="showcase-col hdickenson" col="large-2" href="/work/hunter-dickenson">
			...
			<div class="showcase-row top flush">
				<a class="showcase-col" href="/work/soundset">
					<span annotation>04.</span>
					<figure aspect-ratio="4x3">
						<?php snippet('img', array('src' => '/assets/images/home/soundset.jpg')) ?>
					</figure>
				</a>
				<a class="showcase-col" href="/work/tapwater">
					<span annotation>05.</span>
					<figure aspect-ratio="4x3">
						<?php snippet('img', array('src' => '/assets/images/home/tw.jpg')) ?>
					</figure>
				</a>
			</div>

			<div class="showcase-row bottom flush">
				<a class="showcase-col" col="3" href="/work/crowdnoize">
					<span annotation>06.</span>
					<figure aspect-ratio="1x1">
						<?php snippet('img', array('src' => '/assets/images/home/crowdnoize.svg')) ?>
					</figure>
				</a>
				<a class="showcase-col flush-top" href="/work/gazebo">
					<span annotation="left flush-top">07.</span>
					<figure aspect-ratio="4x3">
						<?php snippet('img', array('src' => '/assets/images/home/gazebo.jpg')) ?>
					</figure>
				</a>
			</div>

			<div class="showcase-row top">
				<a class="showcase-col flush-top" col="9" href="/work/dimos-pizza">
					<span annotation="right flush-top">08.</span>
					<figure aspect-ratio="2x1">
						<?php snippet('img', array('src' => '/assets/images/home/dimos.jpg')) ?>
					</figure>
				</a>
			</div>
		</div>
